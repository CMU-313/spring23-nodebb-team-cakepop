...
define('composer', [
	...
	composer.enhance = function (postContainer, post_uuid, postData) {
		...
		*/
		...
		var anonBtn = postConatiner.find('.composer-anon');
		...
		// this ensures that the post anonymously button actually submits the post
		...
		app.parseAndTranslate('composer', data, function (composerTemplate) {
			...
			*/
			...
			if (composer.bsEnvironment === 'xs' || composer.bsEnvironment === 'sm') {
				...
				var anonBtns = postContainer.find('.composer-anon');
